package mosaic.view.ui.buttons
{
    ...
    public class SaveButtonMediatorTest extends TestCase
    {
        protected var instance:SaveButtonMediator;
        ...
        {
            assertTrue("instance is SaveButtonMediator", instance is SaveButtonMediator);
        }
        ...
        {
            var handler:Function = addAsync(check_click_on_view_dispatches_SAVE_REQUESTED_event, 50);
            instance.eventDispatcher.addEventListener(DesignSaveEvent.SAVE_REQUESTED, handler);

            UnitHelpers.clickItem(instance.view);
        }

        protected function check_click_on_view_dispatches_SAVE_REQUESTED_event(e:DesignSaveEvent):void
        {
